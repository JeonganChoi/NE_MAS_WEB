...
def saleTransSearchViews_search(request):
    ...
    with connection.cursor() as cursor:
        cursor.execute(" SELECT ITEM, UP_CODE, CUST_NME, OPT, OPT_NME, PAY_OPT, PAY_NME, GUBUN, DANWI, DANGA "
        ...
        " FROM (                                                     "
        "     SELECT C.ITEM, UP_CODE, C.CUST_NME, C.OPT, C.OPT_NME, C.PAY_OPT, C.PAY_NME, C.GUBUN, C.DANWI, C.DANGA "
