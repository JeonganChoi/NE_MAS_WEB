    ...
    if count > 0:
        ...
        with connection.cursor() as cursor:
            cursor.execute( "INSERT INTO SISACCTT "
                            ...
                            "    (   "
                            "    '" + str(ioDate) + "'"
                            ",   (SELECT IFNULL (MAX(ACRECN) + 1,1) AS COUNTED FROM SISACCTT A WHERE IODATE = '" + str(ioDate) + "' AND ACIOGB = '1' )  "
                            ",   '1'"
                            ",   '" + str(acAmts) + "'"
                            ",   '" + str(outAct) + "'"
                            ",   '" + str(acDesc) + "'"
        ...
        with connection.cursor() as cursor:
            cursor.execute("INSERT INTO SISACCTT "
                            ...
                            "    (   "
                            "    '" + str(ioDate) + "'"
                            ",   (SELECT IFNULL (MAX(ACRECN) + 1,1) AS COUNTED FROM SISACCTT A WHERE IODATE = '" + str(ioDate) + "' AND ACIOGB = '2' )  "
                            ",   '2'"
                            ",   '" + str(acAmts) + "'"
                            ",   '" + str(inAct) + "'"
                            ",   '" + str(acDesc) + "'"
        ...
        with connection.cursor() as cursor:
            cursor.execute("INSERT INTO SISACCTT "
                            ...
                            "    (   "
                            "    '" + str(ioDate) + "'"
                            ",   (SELECT IFNULL (MAX(ACRECN) + 1,1) AS COUNTED FROM SISACCTT A WHERE IODATE = '" + str(ioDate) + "' AND ACIOGB = '3' )  "
                            ",   '3'"
                            ",   '" + str(acAmts) + "'"
                            ",   '" + str(acDesc) + "'"
                            ",   '" + str(creUser) + "'"
